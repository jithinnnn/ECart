...
const productSlice = createSlice({
    ...
    reducers:{
            ...
            navigateNextPage:(state)=>{
                state.currentPage++
            },
            navigatePrevPage:(state)=>{
                state.currentPage--
            }
    },
            ...
            builder.addCase(fetchProducts.fulfilled,
                ...
                builder.addCase(fetchProducts.rejected,
                    (state)=>{
                        state.loading = false
                        state.allProducts= []
                        state.error="API Call has failed....Please try again after sometime"
                    })
    }
})
export const {searchByProduct,navigateNextPage,navigatePrevPage} = productSlice.actions
